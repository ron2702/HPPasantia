...
CREATE OR REPLACE FUNCTION REPEST_CONSULTAR_TODOS() RETURNS TABLE (RE.CEDULA integer, RE.PRIMERNOMBRE varchar(30), RE.PRIMERAPELLIDO varchar(30), ES.CEDULAESCOLAR integer, ES.PRIMERNOMBRE varchar(30), ES.PRIMERAPELLIDO) as $$
DECLARE
...
CREATE OR REPLACE FUNCTION REPEST_CONSULTAR_DETALLE(integer) RETURNS TABLE (RE.CEDULA integer, RE.PRIMERNOMBRE varchar(30), RE.PRIMERAPELLIDO varchar(30), ES.CEDULAESCOLAR integer, ES.PRIMERNOMBRE varchar(30), ES.PRIMERAPELLIDO) as $$
DECLARE
