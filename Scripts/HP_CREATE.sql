...
CREATE TABLE REPRESENTANTE(
	...
	FK_LUGAR 				INTEGER,
	CONSTRAINT CH_TIPO CHECK (TIPO in('Autorizado','Representante I', 'Representante II', 'Otro')),
...
CREATE TABLE EMPLEADO(
	...
	TAREASDIRIGIDAS			VARCHAR(2) NOT NULL,
	FK_LUGAR 				INTEGER NOT NULL,
	CONSTRAINT CH_CARGO CHECK (CARGO in('Docente','Auxiliar', 'Director/a',
	 'Secretario/a', 'Obrero/a','Coordinador/a', 'Administrador/a')),
	CONSTRAINT CH_TAREASDIRIGIDAS CHECK (TAREASDIRIGIDAS in('Si','No')),
...
CREATE TABLE CONTROL_SALIDA(
	...
	CONSTRAINT PK_CONTROL_SALIDA PRIMARY KEY(ID)
);
