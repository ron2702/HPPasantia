...
BEGIN
	...
	IF ((SELECT COUNT(*) FROM REPRESENTANTE WHERE CEDULA = $1) = 1) THEN 
		...
		INSERT INTO REP_EST (ID, FK_CEDULA, FK_CEDULAESCOLAR) VALUES (nextval('repest_id_seq'), FK_REPRESENTANTE, FK_ESTUDIANTE);
		RESULT := 200;
	ELSE
		RESULT := 204;
	END IF;
...
CREATE OR REPLACE FUNCTION REPEST_BORRAR(integer) RETURNS integer AS $$
DECLARE
 RESULT integer;
...
BEGIN
	IF ((SELECT COUNT(*) FROM REPRESENTANTE WHERE CEDULA = $1) = 1) THEN 
		...
		DELETE FROM REP_EST WHERE FK_CEDULA  = $1;
		RESULT := 200;
...
/**************************************CRUD GRUPO****************************************/
CREATE OR REPLACE FUNCTION GRUPO_REGISTRAR(varchar(30), varchar(30), varchar(30), integer, varchar(15)) RETURNS integer AS $$
DECLARE
 RESULT integer;
...
CREATE OR REPLACE FUNCTION GRUPO_MODIFICAR(varchar(30), varchar(30), varchar(30), integer, varchar(15)) RETURNS integer AS $$
DECLARE
 RESULT integer;
...
CREATE OR REPLACE FUNCTION GRUPO_CONSULTAR_TODOS() RETURNS TABLE (CODIGO varchar(30), NOMBRE varchar(30), DESCRIPCION varchar(30), CAPACIDAD integer, PERIODO varchar(15)) as $$
DECLARE
...
CREATE OR REPLACE FUNCTION GRUPO_CONSULTAR_DETALLE(varchar(30)) RETURNS TABLE (CODIGO varchar(30), NOMBRE varchar(30), DESCRIPCION varchar(30), CAPACIDAD integer, PERIODO varchar(15)) as $$
DECLARE
